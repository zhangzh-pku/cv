...
if __name__ == '__main__':
    ...
    path = "/Users/zhangzhihao/Library/Mobile Documents/com~apple~CloudDocs/data_science/3_down/cv/02_assignment/02_assignment/cifar-10/"
    img = Image.open(path + 'Lenna.png')
    img.save(path + '../results/Lenna.png')

    # --------------TODO------------------
    # Copy the first kind of your augmentation code here
    # --------------TODO------------------
    aug1 = tfs.RandomHorizontalFlip(1.0)(img)
    aug1.save(path + '../results/Lenna_aug1.png')

    # --------------TODO------------------
    # Copy the second kind of your augmentation code here
    # --------------TODO------------------
    aug2 = tfs.ColorJitter(0.2, 0.2, 0.2)(img)
    aug2.save(path + '../results/Lenna_aug2.png')
